...
hc_tree <- hclust(
  dist_m,
  method = 'single'  # because the spiral is like line
)
...
dbscan_out <- dbscan(spirals[, c(1, 2)], eps = 0.16, minPts = 3)
...
sc <- specc(as.matrix(spirals[, c(1, 2)]), centers = 3)
